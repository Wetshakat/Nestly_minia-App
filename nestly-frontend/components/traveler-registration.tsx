...
const LOCAL_STORAGE_KEY = "travelerRegistrationFormData"

export function TravelerRegistration({ onSuccess, onBack }: TravelerRegistrationProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/travelers/register", {
        method: "POST",
    ...
    <div className="min-h-screen bg-background py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white border border-border rounded-lg p-8">
          <h1 className="text-3xl font-bold mb-2">Complete Your Traveler Profile</h1>
          <p className="text-muted mb-8">
            Join Nestly to discover unique attractions and experiences.
          </p>
